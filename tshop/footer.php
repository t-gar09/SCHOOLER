                            ...
                            <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"
                                ...
                                <div class="footer-about">
                                    ...
                                    <address class="address">
                                        <span>Address: Jl. Jawa IV C No.15, Tegal Boto Lor, Sumbersari, Kec. Sumbersari, Kabupaten Jember, Jawa Timur 68121.</span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mb-6">
                            <div class="footer-social" data-aos="fade-up" data-aos-delay="0">
                                ...
                                <ul class="footer-social-link">
                                    <li><a href="https://www.instagram.com/schooler.c0/"><i class="fa fa-instagram"></i></a></li>
                                    <li><a href="mailto: schooleraparel@gmail.com"><i class="fa fa-envelope"></i></a></li>
