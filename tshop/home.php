...
>>>>>>> 9561f1662d0f1d1df5708f3ef5ef09b83fafd688
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                            ...
                            <div class="content">
                                ...
                                <a href="product-details-default.html"
                                    class="btn btn-lg btn-outline-golden icon-space-left"><span
                                        class="d-flex align-items-center">Check It Out! <i
                                ...
                                <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                    ...
                                    <div class="content">
                                        <h4 class="title">Tote Bag <br>
                                            Canvas</h4>
                                        <a href="product-details-default.html" class="link-text"><span>Look
                                                For It</span></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="banner-single-item banner-style-2 banner-animation img-responsive"
                                    ...
                                    <div class="content">
                                        <h4 class="title">Tumbrl <br>
                                            Bottle</h4>
                                        <a href="product-details-default.html" class="link-text"><span>Check
                                                now</span></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div
                        ...
                        <div class="col-auto mb-6">
                            <div class="footer-copyright">
                                <p class="copyright-text">&copy; 2023 <a href="index.html">schooler</a>. Made with <i
